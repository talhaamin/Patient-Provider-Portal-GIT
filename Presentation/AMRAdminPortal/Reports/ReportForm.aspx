<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportForm.aspx.cs" Inherits="AMRAdminPortal.Report.ReportForm" %>
...
<body  onload="HideLoader();">
    ...
    <div>
        <%--<rsweb:ReportViewer ID="mainReportViewer" runat="server" Width="700px" Height="600px">ReportServerUrl
        </rsweb:ReportViewer>--%>
