...
$(function () {
    ...
    var AdvisorDesc = $('#txtPAOther'),
        ...
        EMail = $('#txtPAEmail'),
        Notes = $('#txtPANotes'),
        allFields = $([]).add(AdvisorDesc).add(Name).add(ContactAgent).add(Address1).add(City).add(PostalCode).add(CountryCode).add(WorkPhone).add(MobilePhone).add(Fax).add(EMail).add(Notes),
        tips = $(".validateTips");
