...
var classMessageDetail = null;
var classAppointDetailName = "r0";
var classRefillDetailName = "r0";
var classReferralDetailName = "r0";
...
var tempInboxDetail = null;
var objnameInboxDetail = null;
var hasclassinbox = null;
function messageInboxDetail(id,classMessageDetail) {

    //  alert(classMessageDetail);
    ShowLoader();
    hasclassinbox = $("#MessageDetail" + id).hasClass("selected").toString();
 //   alert(hasclassinbox);
    if (hasclassinbox == "false") {
        ...
        if (tempInboxDetail != null) {
            if (objnameInboxDetail == 'r0') {
                $(tempInboxDetail).addClass("r0");
            }
            else {
                $(tempInboxDetail).addClass("r1");
            }
        }


        tempInboxDetail = ("#MessageDetail" + id);
        objnameInboxDetail = classMessageDetail;
      //  alert(objnameInboxDetail);
    }
...
function messageSendDetail(id, value) {
    ...
    //    //  alert(objnameInboxDetail);
    //}
   // alert("detail of send");

   // var obj = jQuery.parseJSON($("#hdInboxDetailJson" + id).val());
   // var obj1 = jQuery.parseJSON($("#hdAppointmentDetailJson" + id).val());

 //   alert("provider from" + obj.ProviderIdFrom);
 //   alert("provider from"+obj.ProviderId_To)
    if (obj.ProviderIdFrom != '0') {
        try {
            ...
            $.ajax({
                ...
                success: function (data) {
                    // if success
                    $('#SentMessageHeader' + id + ' .unread').css('color', '#666699');
                    $('#SentMessageHeader' + id + ' .unread').css('font-weight', '');
                    $('#SentMessageHeader' + id + ' td div').removeClass('unread');
                    if ($('#SentMessageHeader').find(".unread").length > 0) {
                    ...
                    if (value == 'Billing Message' || value == 'General Inquiry')
                    {
                        var html = '<div id="Inform_Head" class="ui-corner-all">';
                        html = html + '<h4 style="padding-top: 10px; margin-left: 10px;">';
                        html = html + '<b>' + obj.MessageType + '</b></h4>';
...
var tempAppointDetail = null;
var objnameAppointDetail = null;
var IsAppointDetailclass = null;
function messageAppointmentDetail(id,classAppointDetailName) {

    //  alert(id);
    
    IsAppointDetailclass = $("#MessageDetail" + id).hasClass("selected").toString();
   // alert(IsAppointDetailclass);
    
    if (IsAppointDetailclass == "false") {
        $("#MessageDetail" + id).addClass("selected").siblings().removeClass("selected");

        $("#MessageDetail" + id).removeClass("r1");
        $("#MessageDetail" + id).removeClass("r0");

        if (tempAppointDetail != null) {
            if (objnameAppointDetail == 'r0') {
                $(tempAppointDetail).addClass("r0");
            }
            else {
                $(tempAppointDetail).addClass("r1");
            }
        }
        tempAppointDetail = ("#MessageDetail" + id);
        objnameAppointDetail = classAppointDetailName;
    }
    ShowLoader();
      ...
      //  alert("hi if");
        ...
        //    alert("hi");
            ...
            if (obj.ProviderIdFrom !== '0') {
                ...
                html = html + 'Preffered Day :' + dayval;
                html = html + '                        <br>';
                var period = obj.PreferredPeriod;
                var periodval = "";
                if (period[0] == '1') {
                ...
                //    periodval += 'Evening ';
                //}
                //html = html + 'Preffered Day :' + periodval;
                //html = html + '                        <br>';
                //html = html + 'Urgent :' + (obj.MessageUrgency ? "Yes" : "No");
                //html = html + '                        <br>';

                //html = html + 'Preffered Time of Day :' + dayval;
                //html = html + '                        <br>';
                //html = html + 'Preffered Time :' + obj.PreferredTime;
            }
...
var tempRefillDetail = null;
var objnameRefillDetail = null;
var hassrefillclass=null;
function messageRequestRefillDetail(id, classRefillDetailName) {
    hassrefillclass = $("#MessageDetail" + id).hasClass("selected").toString();
    if (hassrefillclass == "false") {
        $("#MessageDetail" + id).addClass("selected").siblings().removeClass("selected");

        $("#MessageDetail" + id).removeClass("r1");
        $("#MessageDetail" + id).removeClass("r0");

        if (tempRefillDetail != null) {
            if (objnameRefillDetail == 'r0') {
                $(tempRefillDetail).addClass("r0");
            }
            else {
                $(tempRefillDetail).addClass("r1");
            }
        }
        tempRefillDetail = ("#MessageDetail" + id);
        objnameRefillDetail = classRefillDetailName;
    }
    ShowLoader();
       ...
       //  alert("if");
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    //<!--End of reply part-->
                    html = html + '<div id=\"reply\" style=\"height: 550px;\" class=\"ui-corner-all\">';
                    html = html + '<div style=\"margin-left: 30px;margin-top:-15px;\">';
                    html = html + '        <br>';
                    html = html + '        <br>';
...
var tempReferralDetail = null;
var objnameReferralDetail = null;
var hassrefillrequess = null;
function messageReferralRequestDetail(id,classReferralDetailName) {

     // alert(id);
    ShowLoader();
    hassrefillrequess = $("#MessageDetail" + id).hasClass("selected").toString();
    if (hassrefillrequess == "false") {
        $("#MessageDetail" + id).addClass("selected").siblings().removeClass("selected");

        $("#MessageDetail" + id).removeClass("r1");
        $("#MessageDetail" + id).removeClass("r0");

        if (tempReferralDetail != null) {
            if (objnameReferralDetail == 'r0') {
                $(tempReferralDetail).addClass("r0");
            }
            else {
                $(tempReferralDetail).addClass("r1");
            }
        }
        tempReferralDetail = ("#MessageDetail" + id);
        objnameReferralDetail = classReferralDetailName;
    }
...
var tempInbox = null;
var objnameInbox = null;
var Inboxclassdetail = null;
function inboxDetail(id,classInboxName,value) {
    
    var obj = id;
   
    tempInboxDetail = null;
    Inboxclassdetail = $("#MessageHeader-" + obj).hasClass("selected").toString();
  
    
    if (Inboxclassdetail == "false") {
        ...
        if (tempInbox != null) {
            if (objnameInbox == 'r0') {
                $(tempInbox).addClass("r0");
            }
            else {
                $(tempInbox).addClass("r1");
            }
        }
        tempInbox = ("#MessageHeader-" + obj);
        objnameInbox = classInboxName;
    }
   ...
   // $("#MessageHeader-" + obj).removeClass("r1");
    ...
    {
       // alert("delete");
        var obj = jQuery.parseJSON($("#delete-" + id).val());
        if (obj.MessageType == "Billing Message" || obj.MessageType == "General Inquiry") {
            var html = '<div id="Inform_Head" class="ui-corner-all">';
            html = html + '<h4 style="padding-top: 10px; margin-left: 10px;">';
        ...
        else if (obj.MessageType == "Medication Refill") {
     ...
     //   alert("inbox");
        var obj = jQuery.parseJSON($("#inbox-" + id).val());
        if (obj.MessageRead == 'False') {
            if (obj.ProviderIdFrom != '0') {
    try {
            ...
            success: function (data) {
                // if success
                            ...
                            //else {
                                ...
                                $('#MessageHeader-' + obj.ID + ' td div').css('font-weight', '');
                          //  }
                            $('#circle').html(data.TotalMessages);
                            $('#hdAppointmentMessages').html(data.AppointmentMessages);
                            $('#hdGeneralMessages').html(data.GeneralMessages);
    ...
    //                messageInboxDetail(msgdtlInbox, classMessageDetail);
    //                //$("#detail-inbox-request").hide();
    //            }
    //            else if (value == 'S') {
    //                $("#MessageSentDetailGrid").html(data);
    //                var msgdtlSent = $("#hdFirstDetailInbox").val();
    //                messageInboxDetail(msgdtlSent, classMessageDetail);
    //               // $("#detail-sent-request").hide();
    //            }
    //            else if (value == 'D') {
    //                $("#MessageDeleteDetailGrid").html(data);
    //                var msgdtlDel = $("#hdFirstDetailInbox").val();
    //                messageInboxDetail(msgdtlDel, classMessageDetail);
    //                //$("#detail-delete-request").hide();
    //            }
...
var tempSent = null;
var objnameSent = null;
var SendclassDetail=null;
function sendDetail(id, classSentName, value) {
    ShowLoader();
    $("detail-sent-request").html("");

    tempInboxDetail = null;
    SendclassDetail = $("#SentMessageHeader-" + id).hasClass("selected").toString();


    if (SendclassDetail == "false") {

        $("#SentMessageHeader-" + id).addClass("selected").siblings().removeClass("selected");

        $("#SentMessageHeader-" + id).removeClass("r1");
        $("#SentMessageHeader-" + id).removeClass("r0");

        if (tempSent != null) {
            if (objnameSent == 'r0') {
                $(tempSent).addClass("r0");
            }
            else {
                $(tempSent).addClass("r1");
            }
        }
        tempSent = ("#SentMessageHeader-" + id);
        objnameSent = classSentName;
    }

    var obj = jQuery.parseJSON($("#senthidden-" + id).val());
...
var refillclass = null;
function medicationRefillDetail(id, classRefillName) {

    tempRefillDetail = null;
    refillclass = $("#MessageHeader-" + id).hasClass("selected").toString();
    if (refillclass == "false") {
        $("#MessageHeader-" + id).addClass("selected").siblings().removeClass("selected");
        ...
        tempRefill = ("#MessageHeader-" + id);
        objnameRefill = classRefillName;
    }
    ShowLoader();
    var obj = jQuery.parseJSON($("#Refil-" + id).val());
    if (obj.MessageRead == 'False') {
        if (obj.ProviderIdFrom != '0') {
    try {
                //  alert("if");
    ...
    //           // alert(msgdtlMed);
    //            messageRequestRefillDetail(msgdtlMed, classRefillDetailName);
    //        },
    //        error: function (xhr, ajaxOptions, thrownError) {
    //            //if error
...
var tempReferral = null;
var objnameReferral = null;
var hasreferalclass = null;

function ReferralRequestDetail(id, classReferralName) {
    
    // alert('test');
    tempReferralDetail = null;
    hasreferalclass = $("#MessageHeader-" + id).hasClass("selected").toString();
    if (hasreferalclass == "false") {
        $("#MessageHeader-" + id).addClass("selected").siblings().removeClass("selected");
        $("#MessageHeader-" + id).removeClass("r1");
        $("#MessageHeader-" + id).removeClass("r0");

        if (tempReferral != null) {
            if (objnameReferral == 'r0') {
                $(tempReferral).addClass("r0");
            }
            else {
                $(tempReferral).addClass("r1");
            }
        }
        tempReferral = ("#MessageHeader-" + id);
        objnameReferral = classReferralName;
    }
    ShowLoader();
    var obj = jQuery.parseJSON($("#Refferal-" + id).val());
    if (obj.MessageRead == 'False') {
        if (obj.ProviderIdFrom != '0') {
    try {
    ...
    //            messageReferralRequestDetail(msgdtlRef, classReferralDetailName);
    //        },
    //        error: function (xhr, ajaxOptions, thrownError) {
    //            //if error
                    ...
                    if (bValid) {
                        ...
                        try {
                            ...
                            if (($('#cmbAppointmentFacility option:selected').val()) == -1 && ($('#cmbAppointmentDoctor option:selected').val()) == -1 && ($('#cmbMessageType option:selected').val()) == -1 && ($('#cmbMessageUrgency option:selected').val()) == -1) {
                                alert("Please Select Location , To , Subject , and Message Priority ");
                                return false;
                            }
                                ...
                                alert("Please Select To , Subject , Message Priority");
                                return false;
                            }
                                ...
                                alert("Please Select Location , Subject , Message Priority");
                                return false;
                            }
                                ...
                                alert("Please Select Location , To , Message Priority");
                                return false;
                            }
                                ...
                                alert("Please Select Subject , Message Priority ");
                                return false;
                            }
                                ...
                                alert("Please Select To , Message Priority ");
                                return false;
                            }
                                ...
                                alert("Please Select Message Priority ");
                                return false;
                            }
...
function SentMessage(type) {
    ...
    if (type == 'Reply') {
        if ($('#hdReplyMessageId').val() == '') {
            alert('Please select message before sending a reply.');
            return;
        }
        else {
          //  alert("reply");
            var mDetailId = $('#hdReplyMessageId').val();


            try {
            //    alert("reply");
              //  alert("id is " + mDetailId);
                var obj = jQuery.parseJSON($("#inboxreply-" + mDetailId).val());
               // alert("facilityid is" + obj.FacilityId + "appoitnment doctor" + obj.ProviderIdFrom + " message type" + obj.MessageTypeId + "urgent" + obj.MessageUrgency);
                ...
                $("#cmbMessageUrgency").val(obj.MessageUrgency);
...
//for refil
function SentMessageRefil(type)
{
    $("#PharmAddress").text("");
    $('#cmbMedication').val(-1);
...
//referall
function SentMessageRequest(type)
{
    $("#reqbtn-form").dialog("open");
            ...
            "Send": function () {
                ...
                if (bValid) {
                    ...
                    try {
                        ...
                        //    alert("Please Select Send Request To , Urgency , Preferred Time  option");
                        //    return false;
                        //}
...
function LoadFacilityProviderRequestRefill() {
    ...
    try {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#DivFacilityProviderRequestRefill").html(data);
